<?php
/**
 * Tests for Shurloc_Settings_Page.
 *
 ...
 */
final class ShurlocSettingsPageTest extends TestCase {
	...
	protected function setUp(): void {
		...
		$GLOBALS['shurloc_test_current_user_can']    = true;

		$this->settings = new Shurloc_Settings();

		$this->settings_page = new Shurloc_Settings_Page(
	...
	protected function tearDown(): void {
		unset(
			...
			$GLOBALS['shurloc_test_current_user_can']
		);
	...
	public function test_register_settings_registers_tariff_section(): void {
		...
		$this->assertSame(
			Shurloc_Settings_Page::PAGE_SLUG,
			$section['page']
		);
	}
	...
	public function test_render_page_returns_without_output_for_unauthorized_user(): void {
		$GLOBALS['shurloc_test_current_user_can'] = false;
