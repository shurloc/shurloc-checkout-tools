...
param(
    [string]$PluginName = "shurloc-checkout-tools"
)
...
#
if (-not (Test-Path "$PluginRoot\shurloc-checkout-tools.php")) {
    throw "Plugin bootstrap file 'shurloc-checkout-tools.php' was not copied."
}
