...
The pending JavaScript formatting findings were explicitly abandoned and are
...
The next file should not be changed until this status-document update has been
